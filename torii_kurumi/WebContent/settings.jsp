...
<html>
    ...
    <font face="HGS明朝B" size="8" color="#00008b" class=h4>新規登録画面</font>
        ...
        <div class="main-contents">
            ...
            <form action="settings.jsp" method="post"><br />

                <label for="name">名前</label>
                <input name="name" value="" id="name"/><br />

                <label for="accountid">アカウントID</label>
				<input name="accountid" value="" /><br />
